...
module.exports = [
	...
	//11.GetDriverByClientId
	{
		...
		description:
			"Retrieves the complete list of ALL drivers/LMDPs associated with the client. Use this intent when user asks for 'all drivers list', 'give me the driver list', 'list all LMDPs', 'list all drivers', 'show all drivers with details', 'driver directory', 'get all LMDPs', or any general driver listing query. Returns driver ID, first name, last name, mobile, email, and details. Always output in table format.",
		requiredFields: ["ClientId"],
		followupItem: "driverId",
		exampleResponse: [
			{
	...
	//18. GetLMDPLocationPreferenceList
	{
		...
		description:
			"Retrieves the location preferences (preferred work locations, station preferences, geographic zones) for a SPECIFIC driver/LMDP. Use this ONLY when user explicitly asks about 'location preferences', 'geographic preferences', 'station preferences', 'work location preferences' for a SPECIFIC driver (e.g., 'Show location preferences for driver Alex', 'What are John's location preferences'). REQUIRES a specific DriverId - do NOT use for general driver list queries.",
		requiredFields: ["DriverId", "ClientId"],
		exampleResponse: [
			{
				preference: 1,
